...
<div class="row">
	<a href="{{ route('anggota') }}" class="btn waves-effect waves-light red"><i class="fa fa-arrow-left"></i> Kembali</a>
</div>

<div class="row">
	<div class="col m7 offset-m3">
		<h3 class="blue-text blue-lighten-2 center-align">Biodata Anggota</h3>
				<div class="card z-depth-3">
					...
					<div class="card-content">
						<ul class="collection">
						   <li class="collection-item avatar">
						    ...
						    <li class="collection-item avatar">
						      <i class="fa fa-graduation-cap circle blue accent-2"></i>
						      <span class="title">{{ $data->kelas->nama_kelas }}</span>
						    </li>
							<li class="collection-item avatar">
					...
					@if(Auth::user()->level == 'pembina')
						<div class="card-action">
							<a href="{{ route('anggota.edit', $data->id) }}" class="btn waves-light waves-effect amber accent-4">Edit <i class="fa fa-pencil"></i></a>
						</div>
					@endif
				</div>
	</div>
